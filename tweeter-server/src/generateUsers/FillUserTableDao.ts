...
export class FillUserTableDao {
  ...
  private readonly userImageUrlAttribute = "imageFileExtension";
  private readonly passwordHashAttribute = "password";
  private readonly followeeCountAttribute = "numFollowees";
  private readonly followerCountAttribute = "numFollowers";
